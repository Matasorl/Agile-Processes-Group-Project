...
def analyze_stars_rating(df):
    try:
        ...
        # Filter out actors with too few movies (e.g., < 5)
        fair_actors = actor_summary[actor_summary["num_movies"] >= 5]
        ...
        print(actor_summary_sorted.head(50))
        ...
        # Top 30 Actors by Average Rating (Above vs Below Global Average)
        ...
        # Select top 30 actors by average rating
        top_actors_df = actor_summary_sorted.head(30).reset_index()
        ...
        plt.title("Top 30 Actors by Average Rating (Above vs Below Global Average)", fontsize=14, fontweight='bold')
        ...
        # Save diagram into Images folder
        plt.savefig("../Images/Top 30 Actors by Average Rating (Above vs Below Global Average).png", dpi=300)
