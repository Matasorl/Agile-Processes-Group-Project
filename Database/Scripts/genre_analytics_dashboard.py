...
def main():
    ...
    ap.add_argument("--out-csv", default="Database/Data/genre_avg_ratings_dashboard.csv")
    ap.add_argument("--avg-rating-bar-png", default="Database/Images/genre_rating_bar.png")
    ap.add_argument("--avg-rating-title", default="Average Rating per Genre")
    ap.add_argument("--genre-corr-png", default="Database/Images/genre_rating_correlation_bar.png")
    ap.add_argument("--genre-corr-title", default="Rating vs Genre (Average Rating)")
    ap.add_argument("--dashboard-png", default="Database/Images/genre_dashboard.png")
    ...
    ap.add_argument("--scatter-png", default="Database/Images/rating_vs_votes_scatter.png")
